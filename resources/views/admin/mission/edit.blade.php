...
@section('content')
    ...
    <form action="{{ route('editMission', $mission->id) }}" method="POST" id="content-form">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" value="{{ $mission->name }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="content" value="{{ $mission->content }}" hidden>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="report_body" rows="10" class="form-control">{{ $mission->report_body }}</textarea>
        </div>
        <div class="mb-3">
            <label class="form-label">Заголовки (JSON)</label>
            <textarea name="report_headers" rows="10" class="form-control">{{ $mission->report_headers }}</textarea>
        </div>
